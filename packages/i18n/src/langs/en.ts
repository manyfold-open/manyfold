const en = {
    ...
    web: {
        ...
        landing: {
            ...
            worksWithExternal: 'Dify · Langflow · external',
            meterEyebrow: 'Metering',
            meterColTurn: 'Turn',
            meterColAgent: 'Agent',
            meterColModel: 'Model',
            meterColTokens: 'Tokens',
            meterColLatency: 'Latency',
            meterColCost: 'Cost',
            meterOwnKey: 'your key',
            meterMonthToDate: 'month to date',
            meterProviderBalance: 'provider balance',
            meterTitle: 'Costs you can',
            meterTitleAccent: 'see and steer.',
            meterPoint1Label: 'Visible.',
            meterPoint1Body:
                'Tokens, cost, latency and model, per turn, across every provider.',
            meterPoint2Label: 'Choosable.',
            meterPoint2Body:
                'Managed models or your own keys, picked per agent or per task.',
            meterPoint3Label: 'Capped.',
            meterPoint3Body:
