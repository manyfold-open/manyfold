const en = {
    ...
    web: {
        ...
        emptyState: {
            ...
            runtimesOverviewBody:
                'Agent runtimes and connected machines appear here.',
        ...
        landing: {
            ...
            faqA2: 'Sandboxes are durable but on-demand: ideal for repo tasks where the agent needs files, a terminal, and a session you can pick up later. Cloud computers stay online for cron jobs, connectors, and services that should never sleep.',
            faqQ3: 'Do I need to bring my own provider keys?',
            faqA3: 'You can. Keys are stored per-workspace and routed per-agent — Claude Code on Anthropic, a Codex job on OpenAI, a Gemini CLI session on Google. Or use our metered access for any of them.',
            faqQ4: 'Can I use my own framework agent?',
            faqA4: 'Yes. OpenClaw and Hermes are first-class, and any framework that runs in Linux + has a CLI entry point can be hosted as a custom agent definition.',
            faqQ5: 'How does pricing work?',
            faqA5: 'A flat workspace fee covers the rail, sessions, and one stateful sandbox. Cloud computers and provider tokens are metered. No per-seat tax.',
            ...
            heroTitleAfter: 'One',
            heroTitleAccent: 'fold.',
            heroTagline:
                'Any agent framework, or bring your own, all from one workspace.',
            heroFloorClaim: 'Your workspace · many agents · all frameworks',
            heroFloorBrands: 'Works with',
            handoff: '⇄ handoff',
            heroFoldCta: 'Fold',
            heroFoldHint: 'See the classic hero',
            heroUnfoldCta: 'Unfold',
            heroUnfoldHint: 'Back to the new hero',
            heroClaimHint: 'click an agent to claim & create',
            heroCreateCta: 'create agent',
            demoAgentsLabel: 'Agents',
            demoNowWorking: 'Now working',
            demoScene1Step1: 'Opening the settings page',
            demoScene1Step2: 'Adding the theme toggle',
            demoScene1Thinking: 'Writing tests',
            demoScene1ResultPrefix: 'Dark mode shipped to',
            demoScene1ResultSuffix: 'settings',
            demoScene1Prompt: 'Add dark mode to the settings page.',
            demoScene2Step1: 'Pulling the diff',
            demoScene2Step2: 'Running the test suite',
            demoScene2Thinking: 'Checking for risky changes',
            demoScene2ResultPrefix: 'Looks good,',
            demoScene2ResultSuffix: '2 small suggestions',
            demoScene2Prompt: 'Review PR #284 before I merge it.',
            demoScene3Step1: 'Searching the pricing docs',
            demoScene3Step2: 'Reading 5 recent updates',
            demoScene3Thinking: 'Writing the summary',
            demoScene3ResultPrefix: 'Summary ready,',
            demoScene3ResultSuffix: '3 key changes',
            demoScene3Prompt:
                'Summarize what changed in our pricing docs last week.',
            demoScene4Step1: 'Connecting to the user database',
            demoScene4Step2: 'Counting signups, day by day',
            demoScene4Thinking: 'Drawing the trend chart',
            demoScene4ResultPrefix: '2,418 signups this week,',
            demoScene4ResultSuffix: 'up 18%',
            demoScene4Prompt: 'How many people signed up this week?',
            machinesTitle1: 'Run your workspace',
            machinesTitleAccent: 'anywhere.',
            machinesBody:
                'Spin up a workspace in seconds, keep one running, or wire in your own machines. Mix all three; Manyfold treats them the same.',
            machineCloudName1: 'Try it',
            machineCloudName2: 'instantly',
            machineCloudBody:
                'A fresh workspace in seconds. Perfect for quick tasks and experiments — close it when you’re done, nothing to clean up.',
            machineCloudTag1: 'Hosted',
            machineCloudTag2: 'pay as you go',
            machineLocalName1: 'Keep it',
            machineLocalName2: 'running',
            machineLocalBody:
                'A workspace that stays awake between visits. Your files, tools, and sessions are right where you left them — ready for ongoing work.',
            machineLocalTag1: 'Hosted',
            machineLocalTag2: 'always on',
            machineByoName1: 'Use your',
            machineByoName2: 'own',
            machineByoName3: 'machines',
            machineByoBody:
            ...
            flowBody:
                'No config sprawl. No bespoke wiring. Pick, connect, and start working.',
            flowStep1Title1: 'Pick a',
            flowStep1TitleAccent: 'framework.',
            flowStep1Body:
                'Choose Claude Code, Codex, Gemini CLI, or any agent you already use.',
            flowStep2Title1: 'Connect a',
            flowStep2TitleAccent: 'machine.',
            flowStep2Body:
                'Try one instantly, keep one running, or use your own machine. One click each.',
            flowStep2TileCloud: 'Instant',
            flowStep2TileCloudTag: 'Hosted',
            flowStep2TileLocal: 'Always on',
            flowStep2TileLocalTag: 'Hosted',
            flowStep3Title1: 'Start',
            flowStep3TitleAccent: 'talking.',
            flowStep3Body:
                'Same composer for every agent. Switch frameworks mid-thread.',
            flowStep3You: 'You',
            flowStep3Sample: 'Refactor the auth middleware',
            featuresTitle1: 'The workspace, and everything',
            featuresTitleAccent: 'around',
            featuresTitle2: 'it.',
            featuresBody:
                'Automations, integrations, and connective tissue that make agents a daily habit, not a demo.',
            featAutomateTitleAccent: 'Automate',
            featAutomateTitleRest: 'agent runs.',
            featAutomateBody:
                'Trigger any agent on a schedule, a webhook, a message, or a code event. Same workspace, hands-off.',
            featAutomateWhen: 'When',
            featAutomateWhenValue: '9:00 daily',
            featAutomateRun: 'Run',
            featAutomatePost: 'Post',
            featChannelsTitle1: 'Reach you where you',
            featChannelsTitleAccent: 'already chat.',
            featChannelsBody:
                'Mention an agent in Lark, Slack, Discord, Telegram, or Matrix. The reply lands in the same thread.',
            featThreadTitle1: 'One thread.',
            featThreadTitleAccent: 'Every agent.',
            featThreadBody:
                'Switch between Claude Code, Codex, and Gemini in a single conversation. Context carries across.',
            featThreadStep1Suffix: 'edited 6 files',
            featThreadStep2Suffix: 'audited diff',
            featThreadStep3Suffix: 'cited docs',
            featMcpTitle1: 'Bring your',
            featMcpTitleAccent: 'tools & MCPs.',
            featMcpBody:
                'Plug in MCP servers, custom tools, your own model gateway. Every agent inherits the same toolbox.',
            featMcpRunning: 'running',
            featMcpReady: 'ready',
            faqTitleBefore: 'Frequently',
            faqTitleAccent: 'folded.',
            faqLead:
                'Short answers to the things people ask before they sign up.',
        ...
        runtimeSession: {
            viewerLabel: 'Runtime session viewer',
            sessionActions: 'Runtime session actions',
            sessionLabel: 'Runtime session',
            selectOne: 'Pick a runtime session:',
            noCandidatesFound: 'No session files were found in this runtime.',
            loadingParsing: 'Parsing the selected local session…',
            loadingReading: 'Reading the local runtime raw session…',
            ...
            noUserMessage: '(no user messages)',
            emptyParsedMessages: 'No messages parsed from this local session.',
            emptyRawContent: 'No raw content in this local session.',
            preparing: 'Preparing runtime session…',
            unavailable: 'Runtime session unavailable',
            noRuntimeSessions: 'No runtime sessions',
            selectPlaceholder: 'Select a runtime session',
            currentWebSession: 'current web session',
            viewSection: 'View',
            preview: 'Preview',
            raw: 'Raw',
        ...
        chat: {
            ...
            loadingRuntimeViewer: 'Loading runtime session viewer…',
        ...
        agentNew: {
            ...
            change: 'Change',
            configure: 'Configure',
            newProviderApiKey: 'New {{provider}} API key',
            selectProvider: 'Select {{provider}} provider',
            newApiKeyEntered: 'New API key entered',
            ...
            notAvailableFramework: 'Not available for this framework',
            limitReached: 'Limit reached',
            enabled: 'Enabled',
            off: 'Off',
            notCloning: 'Not cloning',
            selectRuntimeToLoadProfiles: 'Select runtime to load profiles',
            ...
            createNewRuntime: 'Create new runtime',
            addToExistingRuntime: 'Add agent to existing runtime',
            addSelfOwnedComputer: 'Add a self-owned computer',
            rentCloudComputer: 'Rent a cloud computer',
            addToExistingComputer: 'Add agent to existing computer',
            noComputerConnected:
                'No computer connected yet. Register a self-owned machine or rent a cloud computer above.',
            providerModelsNotLoaded:
                'Provider models are not loaded yet. Load them to enable creating this agent.',
            selectSelfOwnedComputer: 'Select self-owned computer',
            ...
            configureRuntimeSettings: 'Configure runtime settings',
            ...
            managedOnMachine: 'Managed on the connected machine',
            configuredAfterRuntime: 'Configured after runtime selection',
            selectConnectedComputer: 'Select a connected self-owned computer',
            ...
            createStatefulSandbox: 'Create Stateful sandbox',
            rentCloud: 'Rent a Cloud computer',
            ...
            computers: 'Computers',
            sandboxTagline: 'Fast, stateful containers',
        ...
        agentRuntimesList: {
            ...
            searchPlaceholder: 'Search runtimes & hosts…',
            searchAria: 'Search runtimes and hosts',
            clearSearch: 'Clear search',
