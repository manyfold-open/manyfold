const en = {
    ...
    web: {
        ...
        agents: {
            detail: {
                a2a: {
                    ...
                    disableDescription:
                        'This agent will stop accepting A2A calls and disappear from peers’ mf a2a status. Existing grants are kept and resume when you re-enable.',
        ...
        runtimeAuth: {
            ...
            removing: 'Removing',
            errorStatus: 'Error',
            defaultForNewAgents: 'Default for new agents',
            makeDefault: 'Use for new agents',
            clearDefault: 'Stop using for new agents',
            signOut: 'Sign out',
            remove: 'Remove',
            usedBy: 'Used by {{count}} agents',
            removeBlocked: 'Move its {{count}} agents to another account first',
            signOutConfirmTitle: 'Sign out of {{account}}?',
            signOutConfirmBody: 'Agents bound to this account stop running until it signs in again. The account stays in the list.',
            ...
            wizardHint: 'The agent runs under this account on the runtime.',
            chatBoundAccount: 'Account: {{account}}',
            bindingConflict: 'The account binding changed elsewhere. Reload and try again.',
            signInFailed: 'Sign-in did not complete: {{reason}}',
            runtimePageLink: 'Manage accounts'
        },
        marketing: {
        ...
        runtimeSession: {
            ...
            inCloud: 'Cloud',
            inLocal: 'Local',
            runtimeCount: 'Showing {{listed}} of {{total}} runtime sessions',
            showMore: 'Show more',
            refresh: 'Refresh',
        ...
        channels: {
            ...
            settings: {
                ...
                fields: { serviceAccountJson: 'Service account JSON key', msteamsAppId: 'Bot app ID', msteamsAppPassword: 'Bot client secret', msteamsTenantId: 'Tenant ID', msteamsAppIdKeep: 'Bot app ID (leave blank to keep existing)', msteamsAppPasswordKeep: 'Bot client secret (leave blank to keep existing)', msteamsTenantIdKeep: 'Tenant ID (leave blank to keep existing)', msteamsAllowedConversationIds: 'Allowed conversation IDs', msteamsServiceUrl: 'Bot Connector endpoint (leave blank for the public cloud)', serviceAccountJsonKeep: 'Service account JSON key (leave blank to keep existing)', googlechatAudienceType: 'Authentication audience', googlechatAudience: 'Audience value', googlechatAudienceAppUrl: 'HTTP endpoint URL', googlechatAudienceProjectNumber: 'Project number', googlechatAllowedSpaceIds: 'Allowed space IDs',
                    ...
                    channelSecret: 'Channel secret', channelSecretKeep: 'Channel secret (leave blank to keep existing)', channelAccessToken: 'Channel access token', channelAccessTokenKeep: 'Channel access token (leave blank to keep existing)', allowedLineChatIdsOptional: 'Allowed group / room IDs (comma-separated, optional)', bluebubblesServerUrl: 'BlueBubbles server URL', bluebubblesServerPassword: 'BlueBubbles server password', bluebubblesServerPasswordKeep: 'BlueBubbles server password (leave blank to keep existing)', wakeWords: 'Wake words (comma-separated)', allowedImessageChatIdsOptional: 'Allowed chat GUIDs (comma-separated, optional)'
                },
                options: {
                ...
                behaviors: { googlechatAutoThread: 'Reply in the message thread', googlechatAutoThreadDescription: 'Google Chat starts a thread for every new message in a space. Reply inside it so the whole exchange stays together.',
                ...
                webhookHelp: { msteams: 'Paste this URL into the Azure portal as the bot messaging endpoint, under your Azure Bot resource, Settings, Configuration.', googlechat: 'Paste this URL into the Google Cloud console under Chat API, Configuration, Connection settings, HTTP endpoint URL.', telegram: 'Telegram webhook is registered automatically when credentials are saved — nothing to paste.', slack: 'Paste this URL into your Slack app under Event Subscriptions → Request URL.', lark: 'Paste this into {{platform}} Open Platform → Event Subscriptions → Request URL.', github: 'The Create GitHub App flow sets this webhook URL on the app automatically; for a hand-created app, set it as the app webhook URL with the issues and issue_comment events.', line: 'The LINE webhook URL is set automatically when credentials are saved — nothing to paste. Turn on "Use webhook" in the LINE Developers console under Messaging API, and turn off Auto-reply messages there so the bot does not answer twice.', imessage: 'Manyfold registers this webhook on your BlueBubbles server itself, with a per-channel secret appended to the URL — the URL shown here is only the base. Anyone who can read the registered URL in the BlueBubbles webhook list can send messages to this agent.', other: 'Paste this URL into your provider event subscription configuration.' },
        ...
        agentNewV4: {
            ...
            blocked: {
                ...
                workspace: 'The workspace has to be an absolute path',
            ...
            cost: {
                ...
                signInDetail: 'Sign in with your {{vendor}} subscription',
