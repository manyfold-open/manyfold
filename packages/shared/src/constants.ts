...
export const auditAction = {
    ...
    USER_DELETION_SELF_REQUESTED: 'user.deletion.self_requested',
    USER_DELETION_SELF_CONFIRMED: 'user.deletion.self_confirmed',
    USER_DELETION_SELF_RESTORED: 'user.deletion.self_restored',
    USER_EXPORT_REQUESTED: 'user.export.requested',
    USER_EXPORT_READY: 'user.export.ready',
    USER_EXPORT_FAILED: 'user.export.failed',
