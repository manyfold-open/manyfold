...
const CAUSE_BY_CODE: Readonly<Record<string, ChatFailureCause>> = {
    ...
    // The turn names a model from a vendor other than its key's, or a
    // platform agent has no provider bound at all: both are fixed in Agent
    ...
    a2a_http_400: 'invalid_request',
    a2a_http_401: 'auth_invalid',
    a2a_http_402: 'balance_exhausted',
    a2a_http_429: 'rate_limited',
