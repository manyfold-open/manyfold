...
- 通过网页工作区、`mf` CLI、[Slack](/zh/docs/channels/slack/)、[Lark、飞书](/zh/docs/channels/lark/)、[Telegram](/zh/docs/channels/telegram/)、[Discord](/zh/docs/channels/discord/) 或 [Matrix](/zh/docs/channels/matrix/) 访问同一个 Agent。
...
- [连接模型提供方](/zh/docs/model-providers/)
