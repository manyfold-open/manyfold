...
Inspect a skill's `SKILL.md` and supporting files before installing it. A skill
can instruct an agent to use tools and external systems with your authority.
