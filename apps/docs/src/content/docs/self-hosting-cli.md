...
or contact any API. See [Install the CLI](/docs/install/) for Windows, choosing a
...
its own [profile](/docs/profiles/) rather than overwriting the default one. A
...
[Register a self-owned computer](/docs/local-daemons/) covers verification,
...
the serving section of [Self-hosting](/docs/self-hosting/).
