...
// (ADR-0031): a daemon that advertises it. Everywhere else the control is
// not offered at all, so the browser terminal keeps its name.
test('the handoff is offered only on a daemon that advertises herdr', () => {
