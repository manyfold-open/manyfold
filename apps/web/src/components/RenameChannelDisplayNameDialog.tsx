...
interface RenameChannelDisplayNameDialogProps {
    channelId: string
    channelSessionId: string
    initialDisplayName: string
    onClose: () => void
    onRenamed: (displayName: string | null) => void
}

const RenameChannelDisplayNameDialog: FC<
    RenameChannelDisplayNameDialogProps
> = ({
    channelId,
    channelSessionId,
    initialDisplayName,
    ...
    const unchanged = trimmed === initialDisplayName.trim()
    ...
    const handleSubmit = async (e: FormEvent): Promise<void> => {
        ...
        setError(null)
        try {
            const nextDisplayName = trimmed.length === 0 ? null : trimmed
            await client.channels.updateSession(channelId, channelSessionId, {
    ...
    return createPortal(
        <div
            ...
            role='dialog'
            aria-modal='true'
            aria-label={t('web.rename.channelTitle')}
            onClick={(e) => {
...
export default RenameChannelDisplayNameDialog
